...
$(function() {
    ...
    $(".txtHijriDate").datepicker({
        ...
        i18n: {
            ...
            previousMonth: '‹',
            nextMonth: '›',
            months: ['محرم', 'صفر', 'ربيع الاول', 'ربيع الاخر', 'جمادي الاول', 'جمادي الاخرة', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
            monthsShort: ['محرم', 'صفر', 'ربيع1', 'ربيع2', 'جمادي1', 'جمادي2', 'رجب', 'شعبان', 'رمضان', 'شوال', 'ذو القعدة', 'ذو الحجة'],
            weekdays: ['الاحد', 'الاثنين', 'الثلاثاء', 'الاربعاء', 'الخميس', 'الجمعه', 'السبت'],
            weekdaysShort: ['سبت', 'اثنين', 'ثلاث', 'اربع', 'خميس', 'جمعه', 'سبت'],
            weekdaysAbbrev: ['ح', 'ن', 'ث', 'ر', 'خ', 'ج', 'س']
        },
