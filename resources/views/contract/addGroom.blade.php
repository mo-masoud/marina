        ...
        {{ csrf_field() }}
            ...
            <div class="col-md-6 col-xs-12  wow fadeInDownBig">
                <div class="form-group">
                    ...
                    <input maxlength="100" type="number" class="form-control" placeholder="{{ trans('front.identity') }}" required name="identity" value="{{ old('identity') }}" />
            ...
            <div class="col-md-6 col-xs-12  wow fadeInDownBig">
             ...
             <div class="col-md-6 col-xs-12  wow fadeInDownBig">
                <div class="form-group">
                    <label class="control-label">جهه اصدار الهوية</label>
                    
            <input maxlength="100" type="text" name="identity_source" class="form-control" placeholder="مصدر الهوية">
            ...
            <div class="col-md-6 col-xs-12  wow fadeInDownBig">
                <div class="form-group">
                    ...
                    <input maxlength="100" type="number" class="form-control" placeholder="{{ trans('front.mobile') }}" required name="phone" value="{{ old('phone') }}" />
