...
<div class="choose-login wow fadeInDownBig">
    ...
    <a href="{{ url('singers') }}" class="btn-style nextPage animation-div">{{ trans('front.enter_singers') }}</a>
    <a href="{{ url('complains') }}" class="btn-style nextPage animation-div">{{ trans('front.To complain') }}</a>
</div>
