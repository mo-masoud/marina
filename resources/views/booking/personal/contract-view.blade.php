            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> {{ App\User::whereId(orderdata('singer_female_id'))->first()->name }}</td>
                    </tr>
                    @endif
                    
                    @if(orderdata('singer_gender') ==  'male')
                    <tr>
                        <td>{{ trans('front.singer_name_male') }}</td>
                        <td> {{ App\User::whereId(orderdata('singer_male_id'))->first()->name }}</td>
                    </tr>
                    @endif
            ...
            <div class="modal-content">
              <div class="modal-body">
                ...
                <table class="client">
                    <tr>
                        ...
                        <td><input type="text" value="{{ orderdata('code_number') }}" readonly /></td>
                    </tr>
                    <tr>
                        <td colspan="3">
              ...
              <div class="modal-footer">
                <span>{{ trans('front.please_press_in_final_saveToSave') }}</span>
                  <form method="POST" action="{{ url('/finalStep/0') }}">
        ...
        <div class="modal fade" id="t2">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <form method="POST" action="{{ url('finalStep/1') }}">
                    {{ csrf_field() }}
                    <div class="col-xs-6">
