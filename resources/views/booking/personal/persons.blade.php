...
<div class="form-style animation-fast">
    ...
    <form action="{{ url('/booking/marina/persons') }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="col-md-6 col-xs-12  wow animation-div">
            <div class="form-group">
                <label class="control-label">{{ trans('front.appropriate_type') }}</label>

                <input type="hidden" name="persons" value="marina">
                 <div class="select">
        ...
        <div class="col-md-6 col-xs-12 wow animation-div">
            <div class="form-group popover-markup">
                <div class="trigger">
                    ...
                    <input type="text" id="passengers" value="0" name="number_bridal" class="form-control" value="{{ orderdata('number_bridal') }}" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="select">
                    <select id="type" name="singer_gender">
                        <option value="female" {{ ( orderdata('singer_gender') == 'female'  ) ? 'selected' :'' }}>@lang('front.femaleSinger')</option>
                        <option value="male" {{ ( orderdata('singer_gender') == 'male'  ) ? 'selected' :'' }}>@lang('front.maleSinger')</option>
                    </select>
        ...
        <div class="col-xs-12 padding types wow fadeInDownBig" id="female">
            <div class="col-md-6 col-xs-12 ">
                <div class="form-group">
                    ...
                    <select name="singer_female_id">
                        <option selected>@lang('front.name')</option>
                        @foreach($females as $female)
                            <option value="{{ $female->id }}" {{ ( orderdata('singer_female_id') ==  $female->id   ) ? 'selected' :'' }}>{{ $female->name }}</option>
                        @endforeach
                    </select>
                    <i class="fa fa-microphone"></i>
                </div>
        ...
        <div class="col-xs-12 padding types hideT wow fadeInDownBig" id="male">
            <div class="col-md-6 col-xs-12 ">
                <div class="form-group">
                    ...
                    <select name="singer_male_id">
                        <option selected>الإسم</option>
                        @foreach($males as $male)
                            <option value="{{ $male->id }}" {{ ( orderdata('singer_male_id') ==  $male->id  ) ? 'selected' :'' }}>{{ $male->name }}</option>
                        @endforeach
                    </select>
                    <i class="fa fa-microphone"></i>
                </div>
   ...
   <div class="col-md-6 col-xs-12  wow fadeInDownBig">
        ...
        <!--    <div class="form-group">-->
        <!--        <label class="control-label">{{ trans('front.hejry_date') }}</label>-->
        <!--        <input  type="date" date" value="1414-01-01" name="hejry_date" class="w3-input w3-border" placeholder="yyy / mm / 01" required />-->
        ...
        <!--    <div class="form-group">-->
        <!--        <label class="control-label">{{ trans('front.meladi_date') }}</label>-->
        <!--        <input  type="date" name="date"class="w3-input w3-border" placeholder="yyy / mm / 01" required />-->
                <!--<i class="fa fa-calendar"></i>-->
        <!--    </div>-->
        <!--</div>-->
        ...
        <!--    <div class="form-group">-->
        <!--        <label class="control-label">{{ trans('front.hejry_date') }}</label>-->
        <!--        <input id="hijrDate" onclick="pickDate(event)" type="text" name="hejry_date" value="{{ orderdata('hejry_date') }}" class="w3-input w3-border" placeholder="yyy / mm / 01" required />-->
        <!--        <i class="fa fa-calendar"></i>-->
        <!--    </div>-->
        <!--</div>-->
        ...
        <!--    <div class="form-group">-->
        <!--        <label class="control-label">{{ trans('front.meladi_date') }}</label>-->
        <!--        <input id="gregDate" onclick="pickDate(event)" type="text" name="date" value="{{ orderdata('date') }}" class="w3-input w3-border" placeholder="yyy / mm / 01" required />-->
        <!--        <i class="fa fa-calendar"></i>-->
        <!--    </div>-->
        <!--</div>-->
