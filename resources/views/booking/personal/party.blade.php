...
<div class="choose-login">
	...
	<a class="btn-style nextPage animation-div" href="{{ url('music') }}">
        {{ trans('front.concert') }}
    </a>

    <a class="btn-style nextPage animation-div" href="{{ url('no_music') }}">
       {{ trans('front.without_concert') }}
    </a>

    <a class="btn-style nextPage animation-div" href="{{ url('both-music') }}">
