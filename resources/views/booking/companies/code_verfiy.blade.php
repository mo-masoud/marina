...
<div class="form-style">
    ...
    <!--<div class="temp-code"><label class="control-label">{{ $companystep3['code'] }}</label></div>-->

     <form method="POST" action="{{ url('/booking/marina/companies/step4') }}">
       @csrf
        ...
        <div class="col-md-6 col-xs-12 wow fadeInDownBig">
            <div class="form-group">
                ...
                <span class="small-text"><i class="fa fa-exclamation-circle"></i>  ادخل رمز التحقق المرسل عبر جوالك
                    <a href="{{url('/resend/company')}}"><i class="fa fa-refresh"></i> اعد إرسال الكود</a></span>
