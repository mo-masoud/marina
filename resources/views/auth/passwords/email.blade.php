     ...
     <form method="POST" action="{{ route('password.email') }}">
        ...
        <div class="col-md-6 col-xs-12 wow animation-div">
            <div class="form-group">
                <label class="control-label"><i class="fa fa-user"></i> {{ trans('front.mobile') }}</label>
                <input id="email" type="number" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="mobile" value="{{ old('mobile') }}" required placeholder="{{ trans('front.mobile') }}"  />
