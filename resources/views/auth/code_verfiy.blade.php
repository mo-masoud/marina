...
<div class="form-style">
    ...
    <div class="temp-code"><label class="control-label">
        </label></div>
       ...
       @csrf
        <div class="col-md-6 col-md-offset-3 col-xs-12 wow fadeInDownBig">
                <div class="form-group">
                    ...
                    <span class="small-text"><i class="fa fa-exclamation-circle"></i> {{ trans('front.enter_code') }}
                    <a href="{{url('/resend/auth')}}"><i class="fa fa-refresh"></i> اعد إرسال الكود</a></span>
                </div>
            </div>
      <div class="col-xs-12 wow fadeInDownBig">
            <div class="form-group">
