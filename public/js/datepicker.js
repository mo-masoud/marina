...
Date.prototype.getDateString = function() {
    ...
    return Datepicker.getDigit(this.getDate() + ' ' + this.getMonthName() + ' ' + this.getYearString())
};
...
HijriDate.prototype.getDateString = function() {
   ...
   var newdate = '';
  if(this.getDate() < 10){
     newdate = '0'+this.getDate();
  }else{
    newdate = this.getDate();
  }
  
    return Datepicker.getDigit(newdate + ' ' + this.getMonthName() + ' ' + this.getYearString())
};
...
Datepicker.language = {
    en: {
        ...
        weekdayNames: ["", "", "", "", "", "", ""],
        weekdayShortNames: ["اح", "اث", "ث", "ار", "خ", "ج", "س"]
    }
};
Datepicker.language.id = {
    ...
    weekdayNames: ["", "", "", "", "", "", ""],
    weekdayShortNames: ["", "", "", "", "", "", ""],
    hMonthNames: ["/01/", "/02/", "/03/", "/04/", "/05/", "/06/", "/07/", "/08/", "/09/", "/10/", "/11/", "/12/"]
};
