...
Object.defineProperty(HijriDate,'parseTime',{value:function(r,t){
	...
	r.ddd=parseInt(hijDay.message)+dc-hdc(m);
...
HijriDate.monthShortNames = ["مح", "ص", "ع1", "ع2", "ج1", "ج2", "رج", "شع", "Ram", "Sya", "DhQ", "DhH"];
HijriDate.weekdayNames = ["01", "02", "", "", "", "", ""];
HijriDate.weekdayShortNames = ["", "", "", "", "", "", ""];
